        ...
        <header class="bg-white w-full shadow h-24">
            ...
            <div class="flex flex-col p-4">
                ...
                <div class="flex flex-wrap">
                    <?php if (isset($commentaires) && is_array($commentaires)): ?>
                            ...
                            <section class="grid place-items-center p-4 w-80">
                                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md w-lg">
                                    ...
                                    <div class="p-6 px-4 pt-0">
                                        <form method="POST" action="../../controllers/CommentaireController.php">
                                            <input type="hidden" name="id" value="<?php echo $commentaire['id']; ?>">
                                            <input type="hidden" name="recette_id" value="<?php echo $commentaire['recette_id']; ?>">
                                            <button name="action" value="delete" class="bg-red-500 text-white px-3 py-1 rounded" onclick="return confirm('Supprimer ce commentaire ?');">Supprimer</button>
                                        </form>
                                    </div>
                                </div>
                            </section>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p class="text-gray-600">Aucun commentaire trouvé.</p>
                    <?php endif; ?>
                    <!-- Formulaire d'ajout -->
                    <section class="grid place-items-center p-4 w-80">
                        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md w-lg p-4">
                            ...
                            <form method="POST" action="../../controllers/CommentaireController.php">
                                <textarea name="contenu" placeholder="Votre commentaire" class="mb-2 p-2 border rounded w-full" required></textarea>
                                <input type="number" name="recette_id" placeholder="ID Recette" class="mb-2 p-2 border rounded w-full" required>
